...
<section class="ftco-section contact-section bg-light">
    <div class="container">
        ...
        <img src="<?= base_url(); ?>foto_pelamar/<?= $pelamar->foto_profil ?>" class="rounded mx-auto d-block" width="40%">
        <center>
            <div class="mt-2">
                <label class="font-weight-bold" for="foto_profil">Upload Foto </label>
                <input type="file" class="btn btn-primary" id="foto_profil" name="foto_profil">
            </div>
        </center><br>
        ...
        <form>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Email" value="<?= $pelamar->nama ?>">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select id="jenis_kelamin" class="form-control" name="jenis_kelamin">
                        ...
                        <option value="<?= $pelamar->jenis_kelamin ?>" disabled selected hidden><?= $pelamar->jenis_kelamin ?></option>
                    </select>
                </div>
                <div class="form-group col-md-4">
                    ...
                    <select id="lulusan" class="form-control" name="lulusan">
                        ...
                        <option value="<?= $pelamar->lulusan ?>" disabled selected hidden><?= $pelamar->lulusan ?></option>
                    </select>
                </div>
