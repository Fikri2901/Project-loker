    ...
    <form>
      ...
      <div class="form-row">
        <div class="form-group col-md-12">
          ...
          <input type="text" class="form-control" id="nama_loker" name="nama_loker" placeholder="Email" value="<?= $loker->nama_loker ?>">
        </div>
        <div class="form-group col-md-12">
          <label for="alamat">Alamat</label>
          <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Username" value="<?= $loker->alamat_lkr ?>">
        </div>
